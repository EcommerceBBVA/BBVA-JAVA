 ...
 */
package mx.bancomer.client.serialization;
...
public abstract class TypeAdapterFactory<C> implements com.google.gson.TypeAdapterFactory {
    ...
    public TypeAdapterFactory(final Class<C> clazz) {
        this.clazz = clazz;
    }
    ...
    public TypeAdapter<C> getClassAdapter(final Gson gson, final TypeToken<C> type) {
        ...
        return new TypeAdapter<C>() {
            ...
            public void write(final JsonWriter out, final C value) throws IOException {
                ...
                TypeAdapterFactory.this.beforeWrite(value, tree);
            ...
            public C read(final JsonReader in) throws IOException {
                ...
                TypeAdapterFactory.this.afterRead(tree);
